...
namespace AirlineTicketingSystemWebApp.Controllers
{
    public class TicketController : Controller
    {
        ...
        private readonly string _getFlightLink = "http://localhost:5156/api/v1/Flight/GET/CODE";
        private readonly string _buyTicketLink = "http://localhost:5156/api/v1/Booking/BUY";
